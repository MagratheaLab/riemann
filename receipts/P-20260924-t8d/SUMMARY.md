...
What changed
Delivered t8d/T8d.lean declaring `theorem three_eq_three : 3 = 3 := rfl`, the smallest allowed proof for packet P-20260924-t8d; no other files touched (allowed_files: t8d/T8d.lean).
