...
What changed
Delivered fixtures/t8e/T8e.lean declaring `theorem four_eq_four : 4 = 4 := rfl`, the smallest allowed proof for packet P-20260924-t8e; no other files touched (allowed_files: fixtures/t8e/T8e.lean).
...
lake build failing in CI; `sorry` or any header/rewrite in fixtures/t8e/T8e.lean; `four_eq_four` not declaring `4 = 4` by `rfl`; edits to files outside allowed_files for P-20260924-t8e.
