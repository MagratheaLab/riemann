...
| Last receipt | `receipts/P-20260924-t8f/` — Ford delivery, owner merged #42. Not a world-proof. |
| Lean on `main` | `RiemannCanon.one_add_one`, `T8Join.t8_join`, `T8c.two_eq_two`, `T8d.three_eq_three`, `T8e.four_eq_four`, `T8f.five_eq_five`. No ξ, no RH. |
